# Expo Discord Outreach Messages for AUT Time & Tools
...
This is a human co-creation. I am looking for a developer who will build the native version with embodied aesthetic judgment, crafted by human hands and hearts.

If this resonates, reach me on Signal at **@zariamorphoenix.33**

---

## Message 2: Developer Requirements (Jobs Channel)
...
**The project:** AUT Time & Tools is a prototype web app that tracks solar and lunar cycles through 12 sacred Ray frequencies. Your role is to transform it into a native, offline-first experience with GPS-secure location handling and sacred visual identity.

**Requirements:**
- At least one shipped React Native app on the App Store or Google Play
- Comfort with SVG animation and custom theming
- Resonance with sacred or mindful technology
- Willingness to co-create with a vision holder who holds vision beyond traditional development
- Human co-creation only, crafted by human hands and hearts.

**Compensation:** Equity + revenue share, or Kickstarter-funded contract. Open to discussion.

**Location:** Remote. Time zone flexible.

**Contact:** Signal at **@zariamorphoenix.33**

Reply with your portfolio or a link to an app you have shipped.

---

## Message 3: Follow-Up (After Initial Post)

Thank you to everyone who has reached out. I am reviewing portfolios this week. The ideal co-creator carries:
